		    ...
		    $screen->add_help_tab( 
		    	array(
			        ...
			        'content'	=> '
			        	...
			        	<p>'.__( '<strong>Image URL</strong> - Set image for this theme. You can choose an image from your media gallery or upload it to "wp-content/uploads/prettythemes/screenshots/" and input file name as "Custom URL". Alternatively, a file with the correct name will be autoloaded even when this field is empty (example: theme location - "wp-content/themes/twentythirteen/", image file - "akismet.png". Only PNG files will work with this method.). "Auto load screenshot with correct name" setting needs to be set to true for it to work. Recommended dimensions are 880px on 660px.','wmd_prettythemes').'</p>
