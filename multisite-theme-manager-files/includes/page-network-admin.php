	...
	<form action="settings.php?page=multisite-theme-manager.php" method="post" enctype="multipart/form-data">
		...
		<table class="form-table">
			<tr valign="top">
				...
				<td>
					<a href="<?php echo esc_url(add_query_arg(array('prettythemes_action' => 'export', '_wpnonce' => $prettythemes_options_nonce))); ?>" class="button"><?php _e('Download Export File', 'wmd_multisitethememanager') ?></a>
					<p class="description">
			...
			<tr valign="top">
				...
				<td>
					<a onclick="return confirm('<?php _e('Are you sure?', 'wmd_multisitethememanager'); ?>')" href="<?php echo esc_url(add_query_arg(array('prettythemes_action' => 'delete_custom_data', '_wpnonce' => $prettythemes_options_nonce))); ?>" class="button"><?php _e('Delete all custom theme data', 'wmd_multisitethememanager') ?></a>
					<a onclick="return confirm('<?php _e('Are you sure?', 'wmd_multisitethememanager'); ?>')" href="<?php echo esc_url(add_query_arg(array('prettythemes_action' => 'reset_settings', '_wpnonce' => $prettythemes_options_nonce))); ?>" class="button"><?php _e('Reset all settings', 'wmd_multisitethememanager') ?></a>
